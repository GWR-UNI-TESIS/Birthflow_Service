...
namespace Birthflow_Service.Infraestructure.Migrations
{
    ...
    [Migration("20240930032709_Agregando_nuevas_tablas_a_la_db")]
    partial class Agregando_nuevas_tablas_a_la_db
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BirthflowService.Domain.Entities.PermissionTypeEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2024, 9, 29, 21, 27, 8, 971, DateTimeKind.Local).AddTicks(4699),
                            Description = "Permisos de lectura",
                            Identificator = new Guid("fd0905dd-320b-4b35-8c12-29b1176803b2"),
                            Name = "Lectura"
                        },
                        new
                        {
                            Id = 2,
                            CreateAt = new DateTime(2024, 9, 29, 21, 27, 8, 971, DateTimeKind.Local).AddTicks(4714),
                            Description = "Permisos de escritura",
                            Identificator = new Guid("b82da4ec-4c89-4520-acc7-4fdd3469f143"),
                            Name = "Escritura"
                        },
                        new
                        {
                            Id = 3,
                            CreateAt = new DateTime(2024, 9, 29, 21, 27, 8, 971, DateTimeKind.Local).AddTicks(4715),
                            Description = "Permisos de lectura y escritura",
                            Identificator = new Guid("8848f375-21d0-4a9a-8f10-e8a5a2c1d13b"),
