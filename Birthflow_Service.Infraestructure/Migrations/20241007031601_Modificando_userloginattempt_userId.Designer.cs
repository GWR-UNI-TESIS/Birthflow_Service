...
namespace Birthflow_Service.Infraestructure.Migrations
{
    ...
    [Migration("20241007031601_Modificando_userloginattempt_userId")]
    partial class Modificando_userloginattempt_userId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BirthflowService.Domain.Entities.PermissionTypeEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2024, 10, 6, 21, 16, 1, 161, DateTimeKind.Local).AddTicks(9595),
                            Description = "Permisos de lectura",
                            Identificator = new Guid("f747771a-3d12-4a60-8c97-2c8890bee22f"),
                            Name = "Lectura"
                        },
                        new
                        {
                            Id = 2,
                            CreateAt = new DateTime(2024, 10, 6, 21, 16, 1, 161, DateTimeKind.Local).AddTicks(9609),
                            Description = "Permisos de escritura",
                            Identificator = new Guid("fe19d9d7-7b83-4f78-bc23-aee5b06ab5cf"),
                            Name = "Escritura"
                        },
                        new
                        {
                            Id = 3,
                            CreateAt = new DateTime(2024, 10, 6, 21, 16, 1, 161, DateTimeKind.Local).AddTicks(9611),
                            Description = "Permisos de lectura y escritura",
                            Identificator = new Guid("e9af054a-67a1-4fe9-9e1d-d62dcc579b5c"),
