...
namespace Birthflow_Service.Infraestructure.Migrations
{
    ...
    [Migration("20240930033359_Modificando_modelo_userGroup")]
    partial class Modificando_modelo_userGroup
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BirthflowService.Domain.Entities.PermissionTypeEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2024, 9, 29, 21, 33, 59, 256, DateTimeKind.Local).AddTicks(8441),
                            Description = "Permisos de lectura",
                            Identificator = new Guid("7d06d5a4-29ea-4461-8d28-791132ccf1e7"),
                            Name = "Lectura"
                        },
                        new
                        {
                            Id = 2,
                            CreateAt = new DateTime(2024, 9, 29, 21, 33, 59, 256, DateTimeKind.Local).AddTicks(8454),
                            Description = "Permisos de escritura",
                            Identificator = new Guid("c1de27d6-620e-4b00-a093-8275817e2e8e"),
                            Name = "Escritura"
                        },
                        new
                        {
                            Id = 3,
                            CreateAt = new DateTime(2024, 9, 29, 21, 33, 59, 256, DateTimeKind.Local).AddTicks(8455),
                            Description = "Permisos de lectura y escritura",
                            Identificator = new Guid("fbdfcc25-fa0e-4c2a-9c93-6b7533454efa"),
