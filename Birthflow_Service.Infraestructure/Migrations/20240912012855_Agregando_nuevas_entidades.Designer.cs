...
namespace Birthflow_Service.Infraestructure.Migrations
{
    ...
    [Migration("20240912012855_Agregando_nuevas_entidades")]
    partial class Agregando_nuevas_entidades
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BirthflowService.Domain.Entities.PartographGroupShareEntity", b =>
                {
                    ...
                    b.Property<long?>("PartographGroupEntityId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("PartographGroupEntityId");
            ...
            modelBuilder.Entity("BirthflowService.Domain.Entities.PartographStateEntity", b =>
                {
                    ...
                    b.Property<long?>("PartographStateEntityId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("PartographStateEntityId");
            ...
            modelBuilder.Entity("BirthflowService.Domain.Entities.PermissionTypeEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2024, 9, 11, 19, 28, 55, 306, DateTimeKind.Local).AddTicks(7291),
                            Description = "Permisos de lectura",
                            Identificator = new Guid("6bd0f20d-a57d-455e-996f-18b0023de7c9"),
                            Name = "Lectura"
                        },
                        new
                        {
                            Id = 2,
                            CreateAt = new DateTime(2024, 9, 11, 19, 28, 55, 306, DateTimeKind.Local).AddTicks(7310),
                            Description = "Permisos de escritura",
                            Identificator = new Guid("798a7a44-2a16-463c-bd6d-30c321b3021e"),
                            Name = "Escritura"
                        },
                        new
                        {
                            Id = 3,
                            CreateAt = new DateTime(2024, 9, 11, 19, 28, 55, 306, DateTimeKind.Local).AddTicks(7312),
                            Description = "Permisos de lectura y escritura",
                            Identificator = new Guid("ba43f5bb-7e45-47a3-bea1-c22ded8519ba"),
            ...
            modelBuilder.Entity("BirthflowService.Domain.Entities.PartographGroupShareEntity", b =>
                {
                    ...
                    b.HasOne("BirthflowService.Domain.Entities.PartographGroupEntity", "PartographGroupEntity")
                        .WithMany("PartographGroupShares")
                        .HasForeignKey("PartographGroupEntityId");
            ...
            modelBuilder.Entity("BirthflowService.Domain.Entities.PartographStateEntity", b =>
                {
                    ...
                    b.HasOne("BirthflowService.Domain.Entities.PartographStateEntity", null)
                        .WithMany("PartographStateEntities")
                        .HasForeignKey("PartographStateEntityId");
            ...
            modelBuilder.Entity("BirthflowService.Domain.Entities.UserGroupEntity", b =>
                {
                    b.HasOne("BirthflowService.Domain.Entities.GroupEntity", "Group")
                        .WithMany("UserGroups")
